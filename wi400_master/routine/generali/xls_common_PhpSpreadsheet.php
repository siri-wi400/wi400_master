...
*/
	...
	//echo "XLS_COMMON_SPREADSHEET<br>";
	
	require_once $routine_path.'/vendor/autoload.php';
	
	use PhpOffice\PhpSpreadsheet\Reader\IReadFilter as PHPExcel_Reader_IReadFilter;
...
// 		echo "STYLE: $style<br>";
		...
		if($error=="I") {
			...
			$sheet->setCellValueExplicitByColumnAndRow($j,$i, $string, PHPExcel_Cell_DataType::TYPE_STRING);
		}
