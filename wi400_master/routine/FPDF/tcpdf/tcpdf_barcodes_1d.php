...
// SIRI - INIZIO
	/**
	 * Stampa del checkdigiit nel codice sotto le barre del barcode
	 */
	public function get_checkdigit() {
...
// SIRI - FINE
	...
	protected function barcode_eanupc($code, $len=13) {
		...
		// SIRI: Aggiunta stampa del check digiit nel codice sotto le barre del barcode
		$this->checkdigit = "";
...
// SIRI - INIZIO
			// SIRI: Aggiunta stampa del check digit nel codice sotto le barre del barcode
			if($len == 8)
				$this->checkdigit = $r;
// SIRI - FINE
