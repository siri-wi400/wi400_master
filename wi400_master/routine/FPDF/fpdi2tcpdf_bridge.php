...
class FPDF extends TCPDF {
	// SIRI - Modifica della funzione per adattarla alla nuova struttura in tcpdf.php
    ...
    function pdf_write_value(&$value) {
        switch ($value[0]) {
			...
			case PDF_TYPE_STREAM:
			    if ($this->encrypted) {
// SIRI - INIZIO
			    	// SIRI - Modifica della chiamata del metodo per adattarla alla nuova struttura
//			        $value[2][1] = $this->_RC4($this->_objectkey($this->_current_obj_id), $value[2][1]);
			        $value[2][1] = TCPDF_STATIC::_RC4($this->_objectkey($this->_current_obj_id), $value[2][1], $last_ley, $last_entry);
// SIRI - FINE
                }
                break;
