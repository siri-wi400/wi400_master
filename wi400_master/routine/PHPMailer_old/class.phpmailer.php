...
class PHPMailer
{
     ...
     */
// SIRI - INIZIO
    // SIRI - Modificato in modo da non avere come alias 'Root User' ogni volta che non viene passato un alias
...
// SIRI - FINE
     ...
     * @return boolean
     */
    // SIRI: Modifica per poter visualizzare un eventutale messaggio di errore
...
// SIRI INIZIO
                    ...
                    if (isset($messageContext)) {
                    	$messageContext->addMessage("ERROR", $exc->getMessage());
                    }
// SIRI FINE
