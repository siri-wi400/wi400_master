...
//	public static function calculateColumnWidth(\PhpOffice\PhpSpreadsheet\Style\Font $font, $cellText = '', $rotation = 0, ?\PhpOffice\PhpSpreadsheet\Style\Font $defaultFont = null)
   	public static function calculateColumnWidth(\PhpOffice\PhpSpreadsheet\Style\Font $font, $cellText = '', $rotation = 0, \PhpOffice\PhpSpreadsheet\Style\Font $defaultFont = null, $margin = 0)
    	{
...
//          $columnWidthAdjust = ceil(self::getTextWidthPixelsExact('n', $font, 0) * 1.07);
            $columnWidthAdjust = ceil(self::getTextWidthPixelsExact('n', $font, 0) * 1.07) + $margin;
// SIRI FINE
...
//          $columnWidthAdjust = self::getTextWidthPixelsApprox('n', $font, 0);
            $columnWidthAdjust = 2*(self::getTextWidthPixelsApprox('n', $font, 0)) + $margin;
// SIRI FINE
