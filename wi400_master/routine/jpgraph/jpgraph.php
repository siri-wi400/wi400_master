...
// Created:     2001-01-08
// Ver:         $Id: jpgraph.php,v 1.4 2017/12/06 16:39:13 lzovi Exp $
//
...
function CheckPHPVersion($aMinVersion) {
	...
	// SIRI: Utilizzata la funzione version_compare per verificare la versione di PHP
	$result = version_compare(PHP_VERSION, $aMinVersion);
	if ($result<0) {
		return false;
	} else {
		return true;
