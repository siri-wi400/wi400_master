...
$font_loc = $routine_path."/barcode/arialbd.ttf";
...
function barcode_outhtml($code, $bars, $scale = 1, $total_y = 0, $space = ''){
    ...
    $out=
      ...
      "<TR><TD><img src='".$temaDir."images/barcode/white.png' height='".$space['top']."' width='1'></TD></TR>"."\n".
      "<TR><TD>"."\n".
     "<IMG src='".$temaDir."images/barcode/white.png' height='".$height2."' width='".$space['left']."'>";
	...
	if ($width){
	    $w=$val*$scale;
	    if ($w>0) $out.="<IMG src='".$temaDir."images/barcode/white.png' height='".$total_y."' width='".$w."' align='top'>";
	    $width=false;
	    continue;
	}
	if (preg_match("/[a-z]/", $val)){
	...
	$w=$val*$scale;
	if ($w>0) $out.="<IMG src='/themes/common/images/barcode/black.png' height='".$h."' width='".$w."' align='top'>";
	$width=true;
    }
    $out.=
      "<IMG src='/themes/common/images/barcode/white.png' height='".$height2."' width='".$space['right']."'>'".
      "</TD></TR>"."\n".
      "<TR><TD><img src='/themes/common/images/barcode/white.png' height='".$space['bottom']."' width='1'></TD></TR>"."\n".
      "</TABLE>"."\n";
