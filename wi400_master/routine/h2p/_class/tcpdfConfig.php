...
if (!defined('K_TCPDF_EXTERNAL_CONFIG')) {
	 ...
	 */
    // SIRI (ALBERTO) non usiamo il composer
    /*$vendorFolders = array(
	...
	//$k_path_main = dirname(dirname(__FILE__)) . "/_tcpdf_5.0.002/";
	//$k_path_main = dirname(dirname(__FILE__)) . "/_tcpdf/";
    $k_path_main = dirname(dirname(__FILE__)) . "/../FPDF/tcpdf/";
    // SIRI FINE
