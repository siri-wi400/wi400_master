...
class GoogleMapAPI {
    ...
    /**
	* Chiave univoca creata nel google cloud di Alberto
	* google dal 16 giugno 2018 ha reso obbligatori la chiave. Senza la chiave la mappa funziona ma in modalità sviluppatore 
	*
	*/
    var $api_key = "AIzaSyA13K4HDYe3YtsqjQZ9bxEWiYGmKtVUViI";
    ...
    function getHeaderJS() { 
		...
		$scriptUrl = "http://maps.google.com/maps/api/js?key=".$this->api_key;
	...
	*/
    ...
    function fetchURL($url) {
        /* Con proxy
         $auth = base64_encode('cvl:baldoria');

$opts = array(
    'http' => array (
        'method'=>'GET',
        'proxy'=>'tcp://10.0.69.12:3128',
