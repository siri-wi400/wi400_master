...
//	public static function calculateColumnWidth(PHPExcel_Style_Font $font, $cellText = '', $rotation = 0, PHPExcel_Style_Font $defaultFont = null) {
	public static function calculateColumnWidth(PHPExcel_Style_Font $font, $cellText = '', $rotation = 0, PHPExcel_Style_Font $defaultFont = null, $margin = 0) {
...
//			$columnWidth += ceil(self::getTextWidthPixelsExact('0', $font, 0) * 1.07); // pixels incl. padding
			$columnWidth += ceil(self::getTextWidthPixelsExact('0', $font, 0) * 1.07) + $margin;
// SIRI FINE
...
//			$columnWidth += self::getTextWidthPixelsApprox('n', $font, 0);
			$columnWidth += 2*(self::getTextWidthPixelsApprox('n', $font, 0)) + $margin;
// SIRI FINE
		}
