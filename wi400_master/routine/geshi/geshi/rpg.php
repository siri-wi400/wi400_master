  ...
  //  'COMMENT_MULTI' => array('*' => ''),
    ...
    'REGEXPS' => array(
      ...
      0 => array(//CALL RPG/RPGLE
        GESHI_SEARCH => /*"(CALL '|CALL      ')(.*?)(')",*/"(CALL\s'|CALL\s')(.*?)(')",
        ...
        GESHI_AFTER => '<font color="red">\3</font>',
    		...
    		4 => array(//BEGSR
    				GESHI_SEARCH => /*'(C           )(.*)(BEGSR)',*//*'(C)(.*)(BEGSR)',*/'(SR\s*|C \s*)(.*?)(\s*BEGSR)',
    		...
    		6 => array(//DS ESTERNE FILE DICHIARATO
    				GESHI_SEARCH => /*'(E DS)(.*)()',*/'(EIDS\s*?|E DS\s*?)(.*?)(\s*\s)',
    				GESHI_REPLACE => '<a href=\'javascript:open("index.php?t=WI_PDM&f=FCON&OGGETTO=\2&TIPO=*FILE","Contenuto")\'><u><font color="red">\2</font></u></a>',
    				GESHI_MODIFIERS => 'Si',
    				GESHI_BEFORE => '\1',
    				GESHI_AFTER => '\3',
    		...
    		10 => array(//DS interne GIALLO + SPECIFICHE DS
    				GESHI_SEARCH => '(I\s*?)(.*?)(\s  DS|\s  SDS)',
