...
$miodato = array("mailto"=>"luca.zovi@gmail.com", "mailcc"=>"a@a.it;b@b.it", "mailsubject"=>"PROVA APERTURA CLIENT", "mailbody"=>"TESTO TESTO E ANCORA TESTo", "mailattach"=>"mio.xls");
$miodato= base64_encode(json_encode($miodato));
$messaggio[] = array("operazione"=>"MAILCLIENT", "dati"=>$miodato);
