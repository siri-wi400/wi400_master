...
class articolo extends Macro {
	...
	public function generate(){
		...
		$userFileKbd = $moduli_path.'/macro/template/'.strtoupper($_SESSION['user']).'_AS400.KMP';
		...
		$campi = array($this->getId(), "M127", $_SESSION['sysinfname'], "", "", "", "", "", 'V',"");
