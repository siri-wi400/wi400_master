...
class rmgac1 extends Macro {
	...
	public function generate(){
        ...
        $fornitore = str_pad($detailKey[1], 6 , " ");
  		// Macro
		$macro = 'autECLSession.autECLPS.SendKeys "'.$fornitore.'"
		...
		$campi = array($this->getId(), "E518", "", "N", $_SESSION['sysinfname'], "", "", "", "", "", 'V',"");
