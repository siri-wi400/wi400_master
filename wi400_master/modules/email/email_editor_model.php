<?php
	...
	else if($actionContext->getForm()=="INVIO") {
		echo "INVIO EMAIL EDITOR<br>";
		
		$detail_name = $_REQUEST['ID_EMAIL_DET'];
		echo "DETAIL NAME: $detail_name<br>";
...
//		$sent = wi400invioConvert::invioEmail($from, $to_array, $dest_array, $subject, $body, array($file_path), array(), $isHtml);
//		$sent = wi400invioConvert::invioEmail($from, $to_array, $dest_array, $subject, $body, $allegati_array, array(), $isHtml);
		$sent = wi400invioConvert::invioEmail($from, $to_array, $dest_array, $subject, $body, $allegati_array, $SMTP, $isHtml);
...
//		$actionContext->onError("CLOSE", "CLOSE_LOOKUP", "", "", true);		
